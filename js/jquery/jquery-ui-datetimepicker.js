		...
		var KEY0 = 48,
			...
			createDateTimePicker = function( input ) {
				...
				var setPos = function() {
					...
					//if( top+datetimepicker[0].height>$(window).height()+$(window).scrollTop() )
					//top = offset.top-datetimepicker[0].offsetHeight+1;
					var offset = datetimepicker.data('input').offset(), top = offset.top-datetimepicker[0].offsetHeight-1, left = offset.left;
